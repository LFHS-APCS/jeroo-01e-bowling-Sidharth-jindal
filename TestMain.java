...
public class TestMain
{
    ...
    public void testBowling() {
       ...
       assertTrue("(1, 3)", Map.getInstance().isFlower(3,1));
       assertTrue("(1, 5)", Map.getInstance().isFlower(5,1));
       assertTrue("(1, 7)", Map.getInstance().isFlower(7,1));
       assertTrue("(2, 2)", Map.getInstance().isFlower(2,2));
       assertTrue("(2, 4)", Map.getInstance().isFlower(4,2));
       assertTrue("(2, 6)", Map.getInstance().isFlower(6,2));
       assertTrue("(3, 3)", Map.getInstance().isFlower(3,3));
       assertTrue("(3, 5)", Map.getInstance().isFlower(5,3));
